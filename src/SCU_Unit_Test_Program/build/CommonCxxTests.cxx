...
int testgetASSMsoilmoisture(int, char*[]);
int testgetASSMtempC(int, char*[]);
int testgetBH1750lux(int, char*[]);
int testgetSensorData(int, char*[]);
int testformat_sensor_data(int, char*[]);
